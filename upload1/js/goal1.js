...
var total = array[0] + array[1] + array[2] + array[3]/4;
console.log("The Average of this array is " + total+".");
...
console.log("Your array contains "+ myArray[0]+ ", "+myArray[1]+", and "+myArray[2]);

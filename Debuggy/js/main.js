 ...
 ***********************/
	...
	var phrase = 'he\'s in ' + ' "PWA1\' "';/*No escape characters*/
	console.log("phrase 4: ", phrase);
	/*Phrase spelled incorrectly*/
	...
	{ /*missing opening bracket
	   *and uncapitilize mood variable*/
		

		if (weather == "Sunny"){
			if (waves === 10){ /*Variable is waves not wave*/
				mood = 'PUMPED';
			...
			if ((waves <= 10) != (waves >= 7)){ /*Change to not equal*/
				mood = "JACKED UP";
		...
		mood = 'totally bummed';			
				...
				/*change parenthesis to closing brackets*/
				mood = 'not happy';
			};

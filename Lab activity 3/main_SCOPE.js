...
var name = firstName +" "+ lastName;
    ...
    /*WILL NOT SHOW UP BECAUSE OF SCOPE. CAN NOT ACCESS THESE VALUES
...
var text = charCount("This is a text string right now");
console.log(text);
...
*******************************************************************************/  
 //--------------------------------------------------------
    console.log("5. how many vowels in a word");
        ...
        function vowelIsInWord(v)
        {
            
            var vowels = "aeiouAEIOU";
            var allVowels = 0;
            for (var ee = 0, hh = v.length; ee < hh; ee++)
            {
                if (vowels.indexOf(v[ee]) != -1)
                {
                allVowels++;    
                    }
                }
        ...
        var vowelTest = vowelIsInWord("How are you doing today there person I don't know?");
